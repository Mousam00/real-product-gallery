<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    ...
    <div v-else-if="!product" class="max-w-4xl mx-auto px-4 py-16 text-center">
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Product Not Found</h1>
    ...
    <div v-else class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="bg-white rounded-2xl shadow p-6 sm:p-8 mb-8">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div class="flex-1">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4" v-html="sanitize(product.title)"></h1>
            ...
            <div class="flex flex-wrap items-center gap-4 mb-4">
              ...
              <span class="border border-green-200 text-green-600 rounded px-2 py-1 text-xs sm:text-sm">Approved Product</span>
            </div>
          ...
          <button
            @click="openModal()"
            class="w-full sm:w-auto bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg font-medium flex items-center justify-center">
      ...
      <div class="space-y-6">
        ...
        <div v-else class="bg-white rounded-2xl shadow p-6">
          <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-4">
            <div class="flex items-center space-x-2">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            <img v-for="(img, i) in product.initialReview.images" :key="i" :src="img"
              alt="Review image"
              class="w-full h-28 sm:h-32 object-cover rounded-lg hover:scale-105 transition-transform cursor-pointer"
